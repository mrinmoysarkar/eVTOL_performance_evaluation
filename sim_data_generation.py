...
def main():
    ...
    eVTOL_types = {'multicopter':28} #{'vector_thrust':74, 'lift_and_cruse':49, 'multicopter':28}
    simulation_types = ['reactive'] #['reactive','strategic']
    algo_types = {'reactive': ['MVP_Bluesky']} #{'reactive': ['MVP_Bluesky', 'straight'],'strategic': ['Decoupled', 'LocalVO', 'SIPP']}
                ...
                for eVTOL in eVTOL_types:
                    for sim_type in simulation_types:
                        for algo_type in algo_types[sim_type]:
                            ...
                            simulation_name = 'run_' + sim_type + '_' + algo_type + '_' + eVTOL + '_' + str(run_no) + '_' + location + '_' + month # A string, will be used to name the log file
