...
def vehicle_setup():
   ...
   #-------------------------------------------------------------------
    ...
    propeller.airfoil_geometry       =  ['./SUAVE/regression/scripts/Vehicles/Airfoils/NACA_4412.txt']
    propeller.airfoil_polars         = [['./SUAVE/regression/scripts/Vehicles/Airfoils/Polars/NACA_4412_polar_Re_50000.txt' ,
                                         './SUAVE/regression/scripts/Vehicles/Airfoils/Polars/NACA_4412_polar_Re_100000.txt' ,
                                         './SUAVE/regression/scripts/Vehicles/Airfoils/Polars/NACA_4412_polar_Re_200000.txt' ,
                                         './SUAVE/regression/scripts/Vehicles/Airfoils/Polars/NACA_4412_polar_Re_500000.txt' ,
                                         './SUAVE/regression/scripts/Vehicles/Airfoils/Polars/NACA_4412_polar_Re_1000000.txt' ]]
    ...
    lift_rotor.airfoil_geometry           =  ['./SUAVE/regression/scripts/Vehicles/Airfoils/NACA_4412.txt']
    lift_rotor.airfoil_polars             = [['./SUAVE/regression/scripts/Vehicles/Airfoils/Polars/NACA_4412_polar_Re_50000.txt' ,
                                         './SUAVE/regression/scripts/Vehicles/Airfoils/Polars/NACA_4412_polar_Re_100000.txt' ,
                                         './SUAVE/regression/scripts/Vehicles/Airfoils/Polars/NACA_4412_polar_Re_200000.txt' ,
                                         './SUAVE/regression/scripts/Vehicles/Airfoils/Polars/NACA_4412_polar_Re_500000.txt' ,
                                         './SUAVE/regression/scripts/Vehicles/Airfoils/Polars/NACA_4412_polar_Re_1000000.txt' ]]
