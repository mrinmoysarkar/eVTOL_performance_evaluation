...
def vehicle_setup():
    ...
    prop.airfoil_geometry         =  ['./SUAVE/regression/scripts/Vehicles/Airfoils/NACA_4412.txt']
    prop.airfoil_polars           = [['./SUAVE/regression/scripts/Vehicles/Airfoils/Polars/NACA_4412_polar_Re_50000.txt' ,
